...
namespace MyAppAPI.Controllers
{
    ...
    public class TokenController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Post(JWTUser _userData)
        {
        ...
        private async Task<JWTUser> GetUser(string email, string password)
        {
            return await _context.JWTUser.FirstOrDefaultAsync(u => u.Email == email && u.Password == password);
        }
    }
}
